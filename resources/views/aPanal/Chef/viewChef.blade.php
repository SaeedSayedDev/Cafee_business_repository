                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row ">
                                        <div class="col-3">
                                            <a class="text-white" href='{{url("/dashboard/chef/$chef->id/edit")}}'> <button type="button" class="btn btn-info btn-sm" data-toggle="modal" title=""><i class="fa fa-edit"></i></button></a>
                                        </div>
